const ChampionManager = {
  ...
  validateChampionName(name) {
    return this.champions.some(champion => 
      champion.toLowerCase() === name.toLowerCase()
    );
  },

  getChampionFileName(championName) {
    const specialCases = {
      "Dr. Mundo": "Dr_Mundo",
      "Nunu": "Nunu_&_Willump"
    };
  ...
  filterChampions(query, limit = 10) {
